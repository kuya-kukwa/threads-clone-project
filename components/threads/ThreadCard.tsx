...
function MediaLightbox({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent
        className="max-w-[100vw] max-h-[100vh] w-full h-full p-0 border-0 rounded-none glass"
      ...
      >
        ...
        <Button
          variant="ghost"
          size="icon"
          className="absolute top-4 right-4 z-50 glass-light border border-white/20 text-white hover:bg-white/20"
          onClick={onClose}
        >
        ...
        {hasMultiple && (
          <>
            <Button
              variant="ghost"
              size="icon"
              className="absolute left-4 top-1/2 -translate-y-1/2 z-50 hidden md:flex glass-light border border-white/20 text-white hover:bg-white/20"
            ...
            <Button
              variant="ghost"
              size="icon"
              className="absolute right-4 top-1/2 -translate-y-1/2 z-50 hidden md:flex glass-light border border-white/20 text-white hover:bg-white/20"
              onClick={goToNext}
            >

...
function MessagesIcon({ className = '', active = false }: { className?: string; active?: boolean }) {
  return active ? (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
function CreateIcon({ className = '' }: { className?: string; active?: boolean }) {
  return (
...
function ActivityIcon({ className = '', active = false }: { className?: string; active?: boolean }) {
  return active ? (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
